...
local function MakeEnemeyInfoFrame()
    ...
    local function DrawGroup1(container)
        ...
        f.enemyDataContainer.healthEditBox:SetLabel("血量")
        ...
        f.enemyDataContainer.creatureTypeEditBox:SetLabel("怪物类型")
        ...
        f.enemyDataContainer.levelEditBox:SetLabel("等级")
        ...
        f.enemyDataContainer.countEditBox:SetLabel("强度")
        ...
        f.enemyDataContainer.teemingCountEditBox:SetLabel("强度(Teeming)")
        ...
        f.enemyDataContainer.stealthCheckBox:SetLabel("潜行")
        ...
        f.enemyDataContainer.stealthDetectCheckBox:SetLabel("潜行侦测")
        ...
        sendSpellsButton:SetText("发送到频道")
        ...
        sendSpellsButton:SetCallback("OnClick",function()
            ...
            SendChatMessage("MDT: "..enemyName.." 的技能:" ,distribution)
...
function MDT:UpdateEnemyInfoFrame(enemyIdx)
    ...
    characteristicsText:SetText("受到影响:")
