...
function MethodDungeonTools:CreateDevPanel(frame)
    ...
    local function DrawGroup1(container)
        ...
        option1:SetLabel("目标楼层")
        option1:SetText(1)
        local option2 = AceGUI:Create("EditBox")
        option2:SetLabel("方向 1up -1d 2r -2l")
        option2:SetText(1)
    ...
    local function DrawGroup2(container)
        ...
        blipsMovableCheckbox:SetLabel("移动拐点")
        ...
        cloneGroupMaxButton:SetText("新建群组")
        ...
        stealthDetectCheckbox:SetLabel("隐身探测")
        ...
        negativeteemingCheckbox:SetLabel("无繁盛")
    ...
    local function DrawGroup5(container)
        ...
        tooltipIndexEditbox:SetLabel("鼠标提示索引")
        ...
        createSpireButton:SetText("创建 Spire+NPC")
