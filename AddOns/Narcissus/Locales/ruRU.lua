...
L["Use Achievement Panel Description"] = "Замените тост за достижение по умолчанию. Щелкните отслеживаемые достижения, чтобы открыть эту панель.";
