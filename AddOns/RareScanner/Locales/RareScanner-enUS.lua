...
if AL then
	...
	AL["CUSTOM_NPC_COORDINATES_DESC"] = "(Obligatory) Coordinates where the NPC can spawn. Introduce the coordinates with the next format: X1-Y1,X2-Y2,.... For example: 0614-6712,75152-4123 (means that the NPC can spawn at the coordinates '6.14-67.12' and '75.152-41.23'). The skull will appear in your map at the first set of coordinates. The rest of coordintes will be used in the overlay layer."
	...
	AL["MAP_SEARCHER_TOOLTIP_TITLE"] = "RareScanner seacher"
	...
	AL["NOTE_168135"] = "You have to be a member of the [Night Fae] Covenant. In order to see this NPC you have to use [Dream Catcher]. Right-click for more instructions."
	...
	AL["NOTE_168135_6"] = "Requires Night Fae Covenant Sanctum. Obtain [Dream Catcher] by talking to [Ysera]"
	...
	AL["NOTE_351541"] = "It is underground, behind a bookshelf in the room to the right. You have to pull the [Anodyne book] that you will find in the middle shelf to find the treasure."
