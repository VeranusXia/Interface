...
if AL then
	...
	AL["DISABLE_SOUND"] = "Disabilita gli avvisi sonori"
	...
	AL["LOOT_TOGGLE_FILTER"] = "Clicca per Attivare/Disattivare il filtro"
	...
	AL["MAP_SHOW_ICON_MAX_SEEN_TIME"] = "Durata per nascondere le icone dei PNG rari (in ore)"
