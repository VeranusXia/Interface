...
private.NPC_INFO = {
	...
	[166710] = { zoneID = 1525, artID = { 1306 }, x = 0.36472294, y = 0.4575452, overlay = { "0.37-0.47","0.36-0.47","0.37-0.46","0.37-0.48","0.36-0.45","0.36-0.49" }, displayID = 94737, questID = { 59913 } }; --Executioner Aatron
	...
	[170439] = { zoneID = 1533, artID = { 1321 }, x = 0.6094027, y = 0.791782, overlay = { "0.61-0.95","0.61-0.89","0.61-0.90","0.59-0.95","0.60-0.95","0.61-0.9","0.61-0.92","0.61-0.94","0.61-0.87","0.62-0.87","0.62-0.84","0.62-0.85","0.62-0.82","0.58-0.96","0.60-0.79","0.61-0.79","0.61-0.91","0.61-0.93","0.61-0.80","0.61-0.86","0.62-0.81","0.62-0.83","0.62-0.86","0.60-0.78","0.58-0.97","0.59-0.96","0.59-0.94","0.6-0.93","0.60-0.93" }, displayID = 94295 }; --Sundancer
	...
	[170932] = { zoneID = 1533, artID = { 1321 }, x = 0.5042933, y = 0.59051555, overlay = { "0.49-0.59","0.50-0.59","0.50-0.58","0.49-0.58","0.49-0.56","0.5-0.59","0.50-0.57","0.51-0.58" }, displayID = 95116, questID = { 60978 } }; --Cloudfeather Guardian
	...
	[171013] = { zoneID = 1533, artID = { 1321 }, x = 0.47975835, y = 0.42881626, overlay = { "0.63-0.35","0.48-0.42","0.47-0.42","0.55-0.14","0.59-0.52","0.48-0.43","0.47-0.44","0.48-0.41","0.52-0.32","0.54-0.15","0.55-0.15","0.59-0.51","0.63-0.36","0.44-0.47","0.46-0.42","0.47-0.41","0.47-0.43","0.55-0.12","0.55-0.13","0.56-0.14","0.59-0.50","0.59-0.53","0.6-0.52","0.45-0.44","0.46-0.43","0.47-0.4","0.48-0.44","0.48-0.45","0.51-0.33","0.62-0.38","0.64-0.36","0.64-0.35","0.46-0.45" }, displayID = 94225, questID = { 61001 } }; --Embodied Hunger
	[171014] = { zoneID = 1533, artID = { 1321 }, x = 0.66011477, y = 0.43675017, overlay = { "0.66-0.43" }, displayID = 94640 }; --Collector Astorestes
	[171040] = { zoneID = 1533, artID = { 1321 }, x = 0.52014446, y = 0.3262239, overlay = { "0.63-0.35","0.47-0.42","0.59-0.51","0.52-0.32","0.55-0.14","0.47-0.43","0.48-0.42","0.56-0.14","0.45-0.41","0.46-0.42","0.46-0.43","0.46-0.41","0.47-0.40","0.48-0.43","0.48-0.44","0.49-0.42","0.63-0.36","0.44-0.42","0.46-0.45","0.47-0.44","0.52-0.31","0.52-0.30","0.63-0.38" }, displayID = 94227 }; --Xixin the Ravening
	[171041] = { zoneID = 1533, artID = { 1321 }, x = 0.52014446, y = 0.3262239, overlay = { "0.48-0.42","0.56-0.14","0.59-0.51","0.47-0.42","0.51-0.32","0.52-0.31","0.55-0.14","0.63-0.36","0.48-0.43","0.59-0.52","0.46-0.43","0.47-0.43","0.48-0.44","0.48-0.39","0.50-0.39","0.51-0.21","0.52-0.32","0.57-0.53","0.57-0.49","0.58-0.51","0.58-0.53","0.59-0.50","0.63-0.35","0.63-0.37","0.64-0.33","0.44-0.42","0.46-0.41","0.48-0.41","0.49-0.44","0.5-0.4","0.50-0.20","0.51-0.31","0.52-0.72","0.52-0.61","0.54-0.30","0.55-0.15","0.55-0.13","0.56-0.12","0.56-0.15","0.58-0.50","0.63-0.38","0.63-0.34","0.64-0.35","0.65-0.34","0.45-0.42","0.48-0.45","0.51-0.33","0.56-0.55","0.57-0.52","0.57-0.51","0.58-0.49","0.59-0.46" }, questID = { 61047 }, displayID = 94229 }; --Worldfeaster Chronn
	...
	[171255] = { zoneID = 1533, artID = { 1321 }, x = 0.44739014, y = 0.6582745, overlay = { "0.46-0.63","0.45-0.68","0.45-0.65","0.44-0.65","0.44-0.64","0.45-0.67","0.46-0.64","0.46-0.66","0.47-0.66","0.47-0.65","0.45-0.64","0.45-0.66","0.47-0.64","0.46-0.67","0.44-0.68" }, displayID = 99373, questID = { 61082 } }; --Echo of Aella <Hand of Courage>
	...
	[171327] = { zoneID = 1533, artID = { 1321 }, x = 0.3164255, y = 0.55161184, overlay = { "0.31-0.55","0.3-0.55","0.30-0.55" }, displayID = 96773 }; --Reekmonger
	...
	[159105] = { zoneID = 1536, artID = { 1323 }, x = 0.4876528, y = 0.2379717, overlay = { "0.49-0.22","0.48-0.23","0.49-0.23","0.48-0.24","0.49-0.24","0.50-0.25","0.46-0.24","0.47-0.24","0.48-0.25","0.48-0.22","0.49-0.19","0.49-0.21","0.5-0.21","0.5-0.24","0.50-0.24","0.50-0.26","0.50-0.22","0.51-0.27","0.50-0.23" }, displayID = 94041, questID = { 58005 } }; --Collector Kash
	...
	[159886] = { zoneID = 1536, artID = { 1323 }, x = 0.5537047, y = 0.2350708, overlay = { "0.55-0.23","0.55-0.24","0.55-0.22","0.54-0.22","0.54-0.21" }, displayID = 96755, questID = { 58003 } }; --Sister Chelicerae
	...
	[161105] = { zoneID = 1536, artID = { 1323 }, x = 0.38807225, y = 0.42598078, overlay = { "0.38-0.42","0.38-0.43","0.39-0.43","0.37-0.43" }, displayID = 94450, questID = { 58332 } }; --Indomitable Schmitd
	[161857] = { zoneID = 1536, artID = { 1323 }, x = 0.504, y = 0.624, overlay = { "0.50-0.62","0.50-0.63","0.5-0.63","0.50-0.61","0.50-0.64" }, displayID = 96863, questID = { 58629 } }; --Nirvaska the Summoner
	...
	[162586] = { zoneID = 1536, artID = { 1323 }, x = 0.44600853, y = 0.52097744, overlay = { "0.44-0.50","0.43-0.51","0.44-0.52","0.44-0.51","0.45-0.52","0.43-0.50","0.45-0.51","0.43-0.52" }, displayID = 96462, questID = { 58783 } }; --Tahonta
	[162588] = { zoneID = 1536, artID = { 1323 }, x = 0.5638136, y = 0.50425124, overlay = { "0.57-0.52","0.57-0.50","0.56-0.51","0.57-0.51","0.56-0.49","0.56-0.50" }, displayID = 94882, questID = { 58837 } }; --Gristlebeak
	[162669] = { zoneID = 1536, artID = { 1323 }, x = 0.45595884, y = 0.26978496, overlay = { "0.44-0.28","0.45-0.28","0.44-0.29","0.45-0.27","0.45-0.30","0.45-0.26","0.44-0.27","0.45-0.25","0.46-0.26","0.46-0.27","0.44-0.26","0.46-0.28" }, displayID = 96375, questID = { 58835 } }; --Devour'us
	...
	[162797] = { zoneID = 1536, artID = { 1323 }, x = 0.48114756, y = 0.5185999, overlay = { "0.46-0.45","0.48-0.51","0.54-0.45","0.53-0.45","0.47-0.45","0.47-0.52","0.48-0.50","0.48-0.52" }, displayID = 96897, questID = { 58878 } }; --Deepscar <Pit Hound>
	...
	[168148] = { zoneID = 1536, artID = { 1323 }, x = 0.50200003, y = 0.48400003, overlay = { "0.50-0.48","0.50-0.47" }, displayID = 99075, questID = { 58784 } }; --Drolkrad
	...
	[156203] = { zoneID = 1543, artID = { 1329 }, x = 0.37134933, y = 0.4448738, overlay = { "0.37-0.44","0.35-0.42","0.36-0.41","0.36-0.43","0.36-0.44","0.37-0.45","0.35-0.44","0.35-0.43","0.34-0.41","0.34-0.42","0.36-0.45" }, displayID = 38549, questID = { 63371 } }; --Stygian Incinerator
	...
	[162849] = { zoneID = 1543, artID = { 1329 }, x = 0.16944754, y = 0.51025635, overlay = { "0.16-0.50","0.16-0.51","0.16-0.49","0.17-0.49","0.17-0.50" }, displayID = 92410, questID = { 60987 } }; --Morguliax <Lord of Decapitation>
	...
	[168693] = { zoneID = 1543, artID = { 1329 }, x = 0.28743148, y = 0.25116977, overlay = { "0.27-0.23","0.28-0.25","0.28-0.24","0.29-0.23","0.27-0.27","0.27-0.24","0.29-0.25","0.26-0.29","0.27-0.28","0.28-0.23","0.3-0.25","0.29-0.26" }, displayID = 94400, questID = { 61346 } }; --Cyrixia <The Willbreaker>
	...
	[170774] = { zoneID = 1543, artID = { 1329 }, x = 0.23793304, y = 0.5298941, overlay = { "0.23-0.53","0.23-0.52","0.22-0.52" }, displayID = 96828, questID = { 60915 } }; --Eketra <The Impaler>
	...
	[172862] = { zoneID = 1543, artID = { 1329 }, x = 0.37399903, y = 0.61429334, overlay = { "0.37-0.62","0.37-0.65","0.38-0.62","0.37-0.60","0.37-0.66","0.37-0.61","0.39-0.60","0.39-0.58","0.38-0.61","0.36-0.61","0.36-0.62","0.37-0.59","0.37-0.58","0.38-0.58","0.38-0.63","0.38-0.60","0.39-0.59" }, displayID = 94426, questID = { 61568 } }; --Yero the Skittish
	...
	[175012] = { zoneID = 1543, artID = { 1329 }, x = 0.43750063, y = 0.5686853, overlay = { "0.38-0.51","0.29-0.49","0.36-0.52","0.31-0.48","0.33-0.49","0.36-0.50","0.42-0.51","0.26-0.51","0.30-0.46","0.31-0.46","0.33-0.47","0.33-0.48","0.34-0.48","0.39-0.50","0.42-0.52","0.44-0.51","0.30-0.48","0.25-0.5","0.25-0.49","0.27-0.49","0.28-0.46","0.28-0.48","0.29-0.47","0.33-0.45","0.35-0.49","0.35-0.52","0.36-0.49","0.36-0.5","0.39-0.65","0.39-0.67","0.39-0.66","0.39-0.49","0.40-0.50","0.41-0.51","0.42-0.50","0.43-0.52","0.43-0.50","0.43-0.51","0.44-0.52","0.45-0.53","0.45-0.54","0.25-0.59","0.23-0.54","0.29-0.48","0.28-0.68","0.30-0.47","0.32-0.48","0.41-0.63","0.39-0.51","0.44-0.53","0.43-0.56" }, displayID = 100033, questID = { 62788 } }; --Ikras the Devourer
	...
	[175846] = { zoneID = 1543, artID = { 1329 }, x = 0.162, y = 0.506, overlay = { "0.16-0.50","0.16-0.49","0.17-0.49","0.17-0.48","0.18-0.48","0.29-0.15","0.3-0.14","0.30-0.14","0.30-0.13","0.30-0.66","0.31-0.13","0.31-0.64","0.31-0.67","0.31-0.62" }, displayID = 96827, questReset = true, worldmap = true }; --Dathlane the Herald <Torghast Executioner>
	...
	[176173] = { zoneID = 1543, artID = { 1329 }, x = 0.22261684, y = 0.47913542, overlay = { "0.22-0.47","0.16-0.50","0.16-0.49","0.17-0.48","0.18-0.48","0.28-0.15","0.29-0.15","0.3-0.14","0.30-0.14","0.30-0.13","0.31-0.13","0.31-0.66","0.31-0.64","0.31-0.63","0.17-0.49","0.31-0.62" }, displayID = 97235, questReset = true, worldmap = true }; --Zograthos <Torghast Executioner>
	[160448] = { zoneID = 1565, artID = { 1338 }, x = 0.67600024, y = 0.5136803, overlay = { "0.67-0.51","0.67-0.52","0.67-0.50","0.66-0.52","0.64-0.51","0.66-0.51" }, displayID = 96274, questID = { 59221 } }; --Hunter Vivanna <The Wild Hunt>
	...
	[164391] = { zoneID = 1565, artID = { 1338 }, x = 0.5297914, y = 0.58215076, overlay = { "0.51-0.57","0.51-0.58","0.50-0.57","0.52-0.58","0.48-0.54","0.49-0.56","0.50-0.58","0.52-0.57" }, displayID = 95115, questID = { 59208 } }; --Old Ardeite
