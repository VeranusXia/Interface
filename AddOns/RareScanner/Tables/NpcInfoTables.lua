...
private.NPC_INFO = {
	...
	[179779] = { zoneID = 1543, artID = { 1329,1693 }, x = 0.66250247, y = 0.55594546, overlay = { "0.66-0.55","0.67-0.55","0.60-0.41","0.60-0.40","0.61-0.41","0.61-0.40","0.62-0.41","0.62-0.42" }, displayID = 96336 }; --Deomen the Vortex
	...
	[179805] = { zoneID = 1543, artID = { 1329,1693 }, x = 0.6937425, y = 0.48122355, overlay = { "0.66-0.49","0.68-0.46","0.68-0.47","0.67-0.47","0.68-0.49","0.69-0.47","0.69-0.48","0.66-0.50","0.67-0.48","0.67-0.50","0.67-0.46","0.68-0.45","0.69-0.49","0.69-0.46","0.65-0.48","0.66-0.48","0.66-0.51","0.67-0.49" }, displayID = 95379, questID = { 64439 } }; --Traitor Balthier <Maldraxxi Champion>
	[179851] = { zoneID = 1543, artID = { 1329,1693 }, x = 0.4913457, y = 0.7364977, overlay = { "0.51-0.71","0.49-0.73","0.51-0.68","0.50-0.71","0.53-0.69","0.53-0.70","0.50-0.75","0.5-0.74","0.51-0.67","0.51-0.75","0.52-0.73","0.53-0.68","0.53-0.72","0.54-0.67","0.54-0.69","0.54-0.71","0.48-0.73","0.49-0.69","0.49-0.72","0.49-0.71","0.49-0.7","0.49-0.70","0.49-0.74","0.49-0.77","0.5-0.76","0.50-0.67","0.50-0.69","0.50-0.77","0.51-0.74","0.52-0.68","0.52-0.74","0.52-0.75","0.53-0.75","0.53-0.71","0.53-0.66","0.54-0.70" }, displayID = 101400, questID = { 64272 } }; --Guard Orguluus
	[179853] = { zoneID = 1543, artID = { 1329,1693 }, x = 0.33408856, y = 0.42289233, overlay = { "0.34-0.41","0.33-0.42","0.35-0.43","0.35-0.44","0.35-0.42","0.35-0.45","0.35-0.40","0.35-0.41","0.36-0.44","0.34-0.40" }, displayID = 22731, questID = { 64276 } }; --Blinding Shadow
	...
	[179913] = { zoneID = 1961, artID = { 1648 }, x = 0.59923196, y = 0.53186107, overlay = { "0.59-0.52","0.6-0.53","0.59-0.51","0.58-0.50","0.58-0.51","0.59-0.53","0.6-0.54","0.60-0.53" }, displayID = 98490, questID = { 64285 } }; --Deadsoul Hatcher
	...
	[180160] = { zoneID = 1961, artID = { 1648 }, x = 0.5697424, y = 0.63328207, overlay = { "0.57-0.62","0.56-0.62","0.56-0.66","0.56-0.67","0.55-0.67","0.56-0.63" }, displayID = 100248, questID = { 64455 } }; --Reliwik the Defiant
	[180162] = { zoneID = 1961, artID = { 1648 }, x = 0.49180782, y = 0.287928, overlay = { "0.61-0.57","0.32-0.43","0.42-0.59","0.48-0.29","0.49-0.29","0.49-0.28" }, displayID = 96510, questID = { 64457 } }; --Ve'rayn <Assets and Liabilities>
}