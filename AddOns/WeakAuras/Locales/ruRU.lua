...
L["Displays the icon for the Legendary Power that matches this bonus id."] = "Отображает иконку легендарной способности, соответствующей этому ID бонуса, вместо иконки предмета"
...
L["Use Legendary Power Icon"] = "Использовать иконку легендарной способности"
