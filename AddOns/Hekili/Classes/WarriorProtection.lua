...
if UnitClassBase( 'player' ) == 'WARRIOR' then
    ...
    spec:RegisterAbilities( {
        ...
        charge = {
            ...
            usable = function () return target.minR > 7, "要求8码以上的距离" end,
        ...
        execute = {
            ...
            usable = function () return target.health_pct < 20, "要求目标低于20%HP" end,
        ...
        revenge = {
            ...
            usable = function ()
                ...
                if toggle.defensives and buff.ignore_pain.down then return false, "如果ignore_pain失败了不要用复仇" end
                if settings.free_revenge and action.revenge.cost ~= 0 then return false, "free_revenge被检查复仇不是免费的" end
    ...
    spec:RegisterSetting( "free_revenge", true, {
        name = "免费|T132353:0|t复仇",
        desc = "如果勾选, 复仇技能只有在消耗0点怒气时才会被推荐使用.",
        type = "toggle",
        width = 1.5
    } )
