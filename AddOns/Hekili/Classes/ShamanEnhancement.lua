...
if UnitClassBase( "player" ) == "SHAMAN" then
    ...
    spec:RegisterAbilities( {
        ...
        flametongue_weapon = {
            ...
            usable = function () return swings.oh_speed > 0, "需要一个随手武器" end,
        ...
        primal_strike = {
            ...
            usable = function () return level < 20, "替换为冰雹" end,
    ...
    spec:RegisterSetting( "pad_windstrike", true, {
        name = "|T1029585:0|t 风切冷却",
        desc = "如果勾选, 插件会将风切的冷却时间稍微缩短, 以帮助确保在升腾期间尽可能频繁地推荐它.",
        type = "toggle",
        width = 1.5
    } )
