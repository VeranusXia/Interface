...
if UnitClassBase( 'player' ) == 'ROGUE' then
    ...
    spec:RegisterAbilities( {
        ...
        marked_for_death = {
            ...
            usable = function ()
                return settings.mfd_waste or combo_points.current == 0, "combo_point (" .. combo_points.current .. ") 不允许浪费"
            end,
        ...
        flagellation = {
            ...
            usable = function ()
                return IsActiveSpell( 323654 ) and buff.flagellation.down, "狂热鞭笞已经激活"
            end,
        ...
        flagellation_cleanse = {
            ...
            usable = function () return IsActiveSpell( 346975 ), "flagellation_cleanse没有激活" end,
    ...
    spec:RegisterSetting( "mfd_waste", true, {
        name = "允许|T236364:0|t死亡标记浪费连击点",
        desc = "如果未勾选, 则该插件将浪费连击点数因此不会推荐|T236364:0|t死亡标记.",
        type = "toggle",
        width = "full"
    } )
