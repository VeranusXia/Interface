...
if UnitClassBase( 'player' ) == 'ROGUE' then
    ...
    spec:RegisterAbilities( {
        ambush = {
            ...
            usable = function () return stealthed.all or buff.blindside.up or buff.sepsis_buff.up, "需要潜行或致盲或败血刃伤触发" end,
        ...
        cheap_shot = {
            ...
            usable = function ()
                if boss then return false, "假设在BOSS战中无法使用cheap_shot" end
                return stealthed.all, "没有潜行"
            end,
        ...
        marked_for_death = {
            ...
            usable = function ()
                return combo_points.current <= settings.mfd_points, "combo_point (" .. combo_points.current .. ") > 用户选择 (" .. settings.mfd_points .. ")"
            end,
        ...
        sap = {
            ...
            usable = function () return stealthed.all or buff.sepsis_buff.up, "需要潜行" end,
            handler = function ()
        ...
        shroud_of_concealment = {
            ...
            usable = function () return stealthed.all, "需要潜行" end,
            handler = function ()
        ...
        stealth = {
            ...
            usable = function () return time == 0 and not buff.stealth.up and not buff.vanish.up, "需要出战而非潜行" end,            
            handler = function ()
                applyBuff( "stealth" )
        ...
        vanish = {
            ...
            disabled = function ()
                return not settings.solo_vanish and not ( boss and group ), "只有在boss战或组队时才能消失"
            end,
        ...
        echoing_reprimand = {
            ...
            disabled = function ()
                return covenant.kyrian and not IsSpellKnownOrOverridesKnown( 323547 ), "你还没有完成格里恩盟约战役"
            end,
        ...
        shadowy_duel = {
            ...
            usable = function () return target.is_player, "需要一个玩家目标" end,
    ...
    spec:RegisterSetting( "priority_rotation", false, {
        name = "注入AOE -> 目标",
        desc = "如果勾选, 当有多个敌人存在时插件的默认优先级列表将集中于将伤害注入你的主要目标.",
        type = "toggle",
        width = 1.5
    } )

    spec:RegisterSetting( "envenom_pool_pct", 50, {
        name = "|T132287:0|t毒伤能量百分比",
        desc = "如果设置为0以上, 则插件将在建议|T132287:0|t毒伤之前汇集到该能量阈值.",
        type = "range",
        min = 0,
        max = 100,
        step = 1,
    ...
    spec:RegisterSetting( "mfd_points", 3, {
        name = "|T236340:0|t 死亡标记连击点",
        desc = "只有当你拥有指定数量的连击点或更少时插件才会推荐|T236364:0|t 死亡标记.",
        type = "range",
        min = 0,
        max = 5,
        step = 1,
    ...
    spec:RegisterSetting( "solo_vanish", true, {
        name = "当单刷时允许|T132331:0|t消失",
        desc = "如果勾选, 当你独自一人时插件不会推荐|T132331:0|t 消失(以避免重置战斗).",
        type = "toggle",
        width = "full"
    } )

    spec:RegisterSetting( "allow_shadowmeld", nil, {
        name = "允许 |T132089:0|t 影遁",
        desc = "如果勾选, |T132089:0|t 当影遁的条件满足时会推荐给暗夜精灵.  你基于隐身的技能可以在影遁中使用即使你的技能栏没有改变.  " ..
            "只有在BOSS战或者组队的时候才能推荐使用影遁(避免重置战斗).",
        type = "toggle",
        width = "full",
