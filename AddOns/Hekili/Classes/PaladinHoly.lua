...
if UnitClassBase( "player" ) == "PALADIN" then
    ...
    spec:RegisterAbilities( {
        ...
        cleanse = {
            ...
            usable = function ()
                return buff.dispellable_poison.up or buff.dispellable_disease.up or buff.dispellable_magic.up, "需要毒、疾病、魔法"
            end,
        ...
        hammer_of_wrath = {
            ...
            usable = function () return target.health_pct < 20 or ( level > 57 and buff.avenging_wrath.up ) or buff.hammer_of_wrath_hallow.up or buff.negative_energy_token_proc.up, "需要低血量, avenging_wrath, 或者 ashen_hallow" end,
            handler = function ()
                gain( buff.holy_avenger.up and 3 or 1, "holy_power" )
                ...
                blessing_of_summer_active = {
                    ...
                    generate = function( t )
                        if IsActiveSpell( 328620 ) then
                            t.name = class.auras.blessing_of_summer.name .. " 激活"
                            t.count = 1
                            t.applied = now
                            t.expires = now + 3600
                            t.caster = "player"
                ...
                blessing_of_autumn_active = {
                    ...
                    generate = function( t )
                        if IsActiveSpell( 328622 ) then
                            t.name = class.auras.blessing_of_autumn.name .. " 激活"
                            t.count = 1
                            t.applied = now
                            t.expires = now + 3600
                            t.caster = "player"
                ...
                blessing_of_winter_active = {
                    ...
                    generate = function( t )
                        if IsActiveSpell( 328281 ) then
                            t.name = class.auras.blessing_of_winter.name .. " 激活"
                            t.count = 1
                            t.applied = now
                            t.expires = now + 3600
                            t.caster = "player"
