...
if UnitClassBase( 'player' ) == 'WARLOCK' then
    ...
    spec:RegisterAbilities( {
        ...
        devour_magic = {
            ...
            usable = function ()
                if buff.dispellable_magic.down then return false, "无可驱散魔法光环" end
                return true
            end,
    ...
    spec:RegisterSetting( "manage_ds_ticks", false, {
        name = "|T136163:0|t 吸取灵魂打断模式",
        desc = "如果勾选, 插件会消耗|cFFFF0000更多的CPU|r来决定什么时候打断|T136163:0|t吸取灵魂的引导而使用" ..
            "其他法术.  这样做一般是不值得的但在技术上是比较准确的.",
        type = "toggle",
        width = "full"
    } )

    spec:RegisterSetting( "agony_macro", nil, {
        name = "|T136139:0|t 痛楚宏",
        desc = "使用宏可以更容易地将你的DOT效果应用到其他目标上而无需切换目标.",
        type = "input",
        width = "full",
        multiline = true,
