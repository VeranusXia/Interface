...
if UnitClassBase( 'player' ) == 'MONK' then
    ...
    spec:RegisterAbilities( {
        ...
        reverse_harm = {
            ...
            usable = function ()
                if not group and health.deficit / health.max < 0.02 then return false, "个人和血量过低" end
                return true
            end,
        ...
        whirling_dragon_punch = {
            ...
            usable = function ()
                if settings.check_wdp_range and target.outside8 then return false, "目标超出进展范围" end
                return true
            end,
    ...
    spec:RegisterSetting( "allow_fsk", false, {
        ...
        desc = "如果未勾选, 则不建议使用|T606545:0|t翔龙在天(这与通过踏风>技能>翔龙在天>禁用该功能相同）.",
        type = "toggle",
        width = "full",
    ...
    spec:RegisterSetting( "optimize_reverse_harm", false, {
        name = "优化|T627486:0|t反向伤害",
        desc = "如果勾选, T627486:0|t反向伤害的标题将显示推荐目标的名称.",
        type = "toggle",
        width = "full",
    } ) 

    spec:RegisterSetting( "tok_damage", 1, {
        name = "需要 |T651728:0|t 业报之触伤害",
        desc = "如果设置为零以上, |T651728:0|t 业报之触只有在你有伤害的时候才会被推荐.",
        type = "range",
        min = 0,
        max = 99,
        step = 0.1,
    ...
    spec:RegisterSetting( "check_wdp_range", false, {
        name = "检查 |T988194:0|t 升龙霸 范围",
        desc = "如果勾选, 当你的目标在 |T988194:0|t 升龙霸 范围之外时, 将不推荐使用.",
        type = "toggle",
        width = 1.5
    } ) 
