...
if UnitClassBase( "player" ) == "DRUID" then
    ...
    spec:RegisterAbilities( {
        ...
        primal_wrath = {
            ...
            usable = function () return combo_points.current > 0, "没有连击点" end,
            handler = function ()
        ...
        regrowth = {
            ...
            usable = function ()
                if buff.prowl.up then return false, "游荡" end
                if buff.cat_form.up and time > 0 and buff.predatory_swiftness.down then return false, "predatory_swiftness被关闭" end
                return true
            end,
        ...
        rip = {
            ...
            usable = function ()
                if combo_points.current == 0 then return false, "没有连击点" end
        ...
        empower_bond = {
            ...
            usable = function ()
                return buff.lone_spirit.up or buff.kindred_spirits.up, "需要kindred_spirits/lone_spirit"
            end,
