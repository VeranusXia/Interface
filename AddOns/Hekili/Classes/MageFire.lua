...
if UnitClassBase( "player" ) == "MAGE" then
    ...
    spec:RegisterAbilities( {
        ...
        combustion = {
            ...
            usable = function () return time > 0, "必须已经在战斗中" end,
            handler = function ()
        ...
        dragons_breath = {
            ...
            usable = function () return target.within12, "目标必须在12码以内" end,
        ...
        fire_blast = {
            ...
            usable = function ()
                if time == 0 then return false, "战斗中没有fire_blast" end
            end,
        ...
        fireball = {
            ...
            velocity = 45,
            usable = function ()
                if moving and settings.prevent_hardcasts then return false, "prevent_hardcasts被选中且玩家正在移动" end
                return true
            end,
        ...
        focus_magic = {
            ...
            usable = function () return active_dot.focus_magic == 0 and group, "可以在组中应用一个" end,
            handler = function ()
        ...
        pyroblast = {
            ...
            usable = function ()
                if action.pyroblast.cast > 0 then
                    if moving and settings.prevent_hardcasts then return false, "prevent_hardcasts被选中且玩家正在移动" end
                    if combat == 0 and not boss and not settings.pyroblast_pull then return false, "开场禁用炎爆术目标不是BOSS" end
                end
                return true
            end,
    ...
    spec:RegisterSetting( "pyroblast_pull", false, {
        name = "允许|T135808:0|t起手炎爆术",
        desc = "如果勾选, 该插件将推荐针对BOSS的起手炎爆术(如果包含在当前优先级中).",
        type = "toggle",
        width = 3,
    } )
    
    spec:RegisterSetting( "prevent_hardcasts", false, {
        name = "防止移动过程中出现 |T135808:0|t 炎爆术 and |T135812:0|t 火球术",
        desc = "如果勾选, 如果炎爆术或火球术有施放时间, 而你又在移动, 那么插件将不会推荐|T135808:0|t 炎爆术 或 |T135812:0|t 火球术.\n\n" ..
            "瞬间 |T135808:0|t 炎爆术不会受影响.",
        type = "toggle",
        width = 3
    } )
