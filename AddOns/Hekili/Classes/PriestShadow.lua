...
if UnitClassBase( "player" ) == "PRIEST" then
    ...
    spec:RegisterAbilities( {
        ...
        shadow_word_death = {
            ...
            usable = function ()
                ...
                return health.percent >= settings.sw_death_protection, "血量百分比 [ " .. health.percent .. " ] 低于用户设置 [ " .. settings.sw_death_protection .. " ]"
            end,
    ...
    spec:RegisterSetting( "pad_void_bolt", true, {
        name = "缩短 |T1035040:0|t 虚空箭CD",
        desc = "如果勾选, 该插件将把|T1035040:0|t 虚空箭的CD略微缩短, 以帮助确保在虚空形态期间尽可能频繁地推荐它.",
        type = "toggle",
        width = "full"
    } )

    spec:RegisterSetting( "pad_ascended_blast", true, {
        name = "缩短 |T3528286:0|t 晋升冲击CD",
        desc = "如果勾选, 该插件将把|T3528286:0|t晋升冲击的CD略微缩短, 以帮助确保在晋升者之赐期间尽可能频繁地推荐它.",
        type = "toggle",
        width = "full"
    } )

    spec:RegisterSetting( "sw_death_protection", 50, {
        name = "|T136149:0|t 暗言术: 灭血量阈值",
        desc = "如果设置为0以上, 当你的血量百分比低于这个阈值时插件将不推荐 |T136149:0|t 暗言术: 灭.  这个设定可以帮助你避免自杀.",
        type = "range",
        min = 0,
        max = 100,
        step = 0.1,
    ...
    spec:RegisterSetting( "stm_timer", 20, {
        name = "|T254090:0|t 疯入膏肓时间",
        desc = "|T254090:0|t 如果你的目标敌人在25秒内没有死亡|T254090:0|t 疯入膏肓将使你死亡.  该插件能够估计死亡时间, 但是 " ..
            "这些数值是估计值.  这个设置可以让你保留一点额外的时间这样你就不太可能造成自己的死亡.\n\n" ..
            "自定义优先级可以参考 |cFFFFD100settings.stm_timer|r 进行决策.",
        type = "range",
        min = 5,
        max = 25,
        step = 0.1,
