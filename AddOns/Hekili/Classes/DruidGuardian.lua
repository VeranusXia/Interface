...
if UnitClassBase( "player" ) == "DRUID" then
    ...
    spec:RegisterAbilities( {
        ...
        barkskin = {
            ...
            usable = function ()
                if not tanking then return false, "玩家现在不是坦克"
                elseif incoming_damage_3s == 0 then return false, "3s内未受到任何伤害" end
                return true
            end,
            handler = function ()
                applyBuff( "barkskin" )
        ...
        bristling_fur = {
            ...
            usable = function ()
                if incoming_damage_3s < health.max * 0.1 then return false, "玩家在3秒钟内没有在伤害中获得10％的生命值" end
                return true
            end,
            handler = function ()
        ...
        --[[ ferocious_bite = {
            ...
            usable = function ()
                if combo_points.current == 0 then return false, "玩家没有连击点" end
                return true
            end,
        ...
        maim = {
            ...
            usable = function () return combo_points.current > 0, "需要combo_points" end,
        ...
        maul = {
            ...
            usable = function ()
                if settings.maul_rage > 0 and rage.current - cost < settings.maul_rage then return false, "怒气不足" end
                return true
            end,
        ...
        prowl = {
            ...
            usable = function ()
                if time > 0 and ( not boss or not buff.shadowmeld.up ) then return false, "战斗中不能隐身"
                elseif buff.prowl.up then return false, "玩家已经在游走" end
                return true
            end,
        ...
        pulverize = {
            ...
            usable = function ()
                if debuff.thrash_bear.stack < 2 then return false, "目标痛击少于2层" end
                return true
            end,
        ...
        regrowth = {
            ...
            usable = function ()
                if not ( buff.bear_form.down and buff.cat_form.down and buff.travel_form.down and buff.moonkin_form.down ) then return false, "玩家处于某种形态" end
                return true
            end,
        ...
        remove_corruption = {
            ...
            usable = function ()
                if buff.dispellable_poison.down and buff.dispellable_curse.down then return false, "玩家没有可驱散的光环" end
                return true
            end,
            handler = function ()
        ...
        swiftmend = {
            ...
            usable = function ()
                return IsSpellUsable( 18562 ) or buff.regrowth.up or buff.wild_growth.up or buff.rejuvenation.up, "需要HoT"
            end,
        ...
        wild_charge = {
            ...
            usable = function () return target.exists and target.distance > 7, "目标必须在8码以上" end,
    ...
    spec:RegisterSetting( "maul_rage", 20, {
        name = "多余怒气|T132136:0|t撕咬",
        desc = "如果设置在零以上, 只有当你至少有这么多的怒气时插件才会推荐|T132136:0|t撕咬.",
        type = "range",
        min = 0,
        max = 60,
        step = 0.1,
    ...
    spec:RegisterSetting( "mangle_more", false, {
        name = "在多目标中更多的使用|T132135:0|t 裂伤",
        desc = "如果勾选, 在|cFFFFD100多目标|r的情况下默认优先推荐更多的 |T132135:0|t裂伤.  与其他方式相比这将产生大约15%的怒气, " ..
            "将更多的伤害传递给你的主要目标，, 但会减少|T134296:0|t 横扫 频率, 对你的次要目标造成更少的伤害/仇恨.",
        type = "toggle",
        width = "full",
    } )

    spec:RegisterSetting( "ironfur_damage_threshold", 5, {
        name = "|T1378702:0|t铁鬃所需伤害百分比",
        desc = "如果设置在零以上, 除非你在过去5秒内受到的伤害大于你最大生命值的这个百分比否则插件不会推荐你使用|T1378702:0|t铁皮.",
        type = "range",
        min = 0,
        max = 100,
        step = 0.1,
    ...
    spec:RegisterSetting( "shift_for_convoke", false, {
        name = "|T3636839:0|t 为万灵之召切换形态",
        desc = "如果勾选且你是法夜, 在使用|T3636839:0|t 万灵之召之前插件会建议你换成你的猫/鸟亲和.  " ..
            "除非你死得很惨否则这是一个DPS收益.",
        type = "toggle",
        width = "full"
    } )
    ...
    spec:RegisterSetting( "catweave_bear", false, {
        ...
        desc = function()
            ...
            return "如果选中插件将使用默认优先级包含的实验性|cFFFFD100变猫|r优先级.\n\n要求 " .. affinity .. "."
        end,
        type = "toggle",
        width = "full",
    } )
    ...
    spec:RegisterSetting( "owlweave_bear", false, {
        ...
        desc = function()
            ...
            return "如果选中插件将使用默认优先级包含的实验性|cFFFFD100变咕|r优先级.\n\n要求 " .. affinity .. "."
        end,
        type = "toggle",
        width = "full"
    } )
