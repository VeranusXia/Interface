...
if UnitClassBase( "player" ) == "WARLOCK" then
    ...
    spec:RegisterAbilities( {
        ...
        health_funnel = {
            ...
            usable = function () return pet.alive and pet.health_pct < 100, "需要受伤的恶魔" end,
        ...
        implosion = {
            ...
            usable = function ()
                if buff.wild_imps.stack < 3 and azerite.explosive_potential.enabled then return false, "explosive_potential的小鬼太少了"
                elseif buff.wild_imps.stack < 1 then return false, "没有小鬼可用" end
                return true
            end,
        ...
        soul_strike = {
            ...
            usable = function () return pet.felguard.up and pet.alive, "需要活的恶魔卫士" end,
            handler = function ()
                gain( 1, "soul_shards" )
            end,
        },
    ...
    spec:RegisterSetting( "implosion_imps", 4, {
        name = "野生小鬼的 |T2065588:0|t 内爆",
        desc = "当使用 |T2065588:0|t 内爆, 默认的优先级将要求你至少有这么多的野生小鬼.\n\n" ..
            "目前的模拟情况是在HAC下至少需要3个小鬼才能达到最佳的DPS, 而在5个" ..
            "以上目标的持续场景中使用4个以上的小鬼的内爆是比较理想的.",
        type = "range",
        min = 3,
        max = 10,
        step = 1,
