...
if UnitClassBase( "player" ) == "PALADIN" then
    ...
    spec:RegisterAbilities( {
        ...
        shield_of_vengeance = {
            ...
            usable = function () return incoming_damage_3s > 0.2 * health.max, "超过3秒的传入伤害少于最大生命值的20％" end,
            handler = function ()
        ...
        wake_of_ashes = {
            ...
            usable = function ()
                if settings.check_wake_range and not ( target.exists and target.within12 ) then return false, "目标在12码外" end
                return true
            end,
    ...
    spec:RegisterSetting( "check_wake_range", false, {
        name = "检查 |T1112939:0|t 灰烬觉醒距离",
        desc = "如果选择, 当你的目标在|T1112939:0|t灰烬觉醒的范围之外时将不推荐使用.",
        type = "toggle",
        width = 1.5
    } )
