...
if UnitClassBase( "player" ) == "DEATHKNIGHT" then
    ...
    spec:RegisterAbilities( {
        ...
        dark_simulacrum = {
            ...
            usable = function ()
                if not target.is_player then return false, "目标不是玩家" end
                return true
            end,
            handler = function ()
        ...
        sacrificial_pact = {
            ...
            usable = function () return pet.alive, "需要一个亡灵宠物" end,
        ...
        -- Stub.
        any_dnd = {
            name = function () return "|T136144:0|t |cff00ccff[任何]|r " .. ( class.abilities.death_and_decay and class.abilities.death_and_decay.name or "Death and Decay" ) end,
        },
    ...
    --[[ spec:RegisterSetting( "festermight_cycle", false, {
        name = "溃烂之力: 传染|T237530:0|t伤害",
        desc = function ()
            return  "如果勾选了, 该插件将鼓励你在|T136144:0|t死亡和腐化之前将溃烂伤害扩散到多个目标.\n\n" ..
                    "需要|cFF" .. ( state.azerite.festermight.enabled and "00FF00" or "FF0000" ) .. "溃烂之力|r (艾泽里特)\n" ..
                    "需要|cFF" .. ( state.settings.cycle and "00FF00" or "FF0000" ) .. "推荐目标互换|r在|cFFFFD100目标|r定位部分."
        end,
        type = "toggle",
        width = "full"
    } ) ]]
