...
if UnitClassBase( "player" ) == "DEATHKNIGHT" then
    ...
    spec:RegisterAbilities( {
        ...
        control_undead = {
            ...
            usable = function () return target.is_undead, "需要亡灵目标" end,
        ...
        sacrificial_pact = {
            ...
            usable = function () return pet.ghoul.alive, "需要一个亡灵宠物" end,
    ...
    spec:RegisterSetting( "save_blood_shield", true, {
        name = "保存|T237517:0|t鲜血护盾",
        desc = "如果勾选, 默认优先级（或任何优先级检查|cFFFFD100save_blood_shield|r）会尽量避免让你的|T237517:0|t鲜血护盾在伤害停滞期间掉落.",
        type = "toggle",
        width = "full"
    } )
