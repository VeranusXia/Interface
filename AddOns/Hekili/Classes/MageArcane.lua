...
if UnitClassBase( 'player' ) == 'MAGE' then
    ...
    spec:RegisterAbilities( {
        ...
        arcane_explosion = {
            ...
            usable = function () return not state.spec.arcane or target.distance < 10, "目标超出范围" end,
            handler = function ()
        ...
        conjure_mana_gem = {
            ...
            usable = function ()
                if GetItemCount( 36799 ) ~= 0 or fake_mana_gem then return false, "已经有一个mana_gem" end
                return true
            end,
        ...
        mana_gem = {
            ...
            usable = function ()
                if GetItemCount( 36799 ) == 0 and not fake_mana_gem then return false, "包里需要mana_gem" end
                return true
            end,
    ...
    spec:RegisterSetting( "arcane_info", nil, {
        type = "description",
        name = "奥术法师模块将战斗视为两个阶段之一.当使用了奥术强化并开始积极燃烧法力时'燃烧'阶段开始.当完成燃烧阶段并使用唤醒来补充法力值时'保存'阶段开始.这个阶段" ..
            "的法力消耗比较少, 所以当你在开始另一个燃烧阶段的时候你就会做好准备.",
