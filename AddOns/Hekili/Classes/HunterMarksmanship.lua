...
if UnitClassBase( "player" ) == "HUNTER" then
    ...
    spec:RegisterAbilities( {
        ...
        aimed_shot = {
            ...
            usable = function ()
                if action.aimed_shot.cast > 0 and moving and settings.prevent_hardcasts then return false, "prevent_hardcasts被确认并且玩家正在移动" end
                return true
            end,
        ...
        survival_of_the_fittest = {
            ...
            usable = function ()
                return not pet.exists or pet.alive, "不需要宠物或活着的宠物"
            end,
            handler = function ()
    ...
    spec:RegisterSetting( "prevent_hardcasts", false, {
        name = "防止在移动过程中出现|T135130:0|t瞄准射击",
        desc = "如果选中, 如果有施放时间并且你正在移动那么插件将不会推荐|T135130:0|t瞄准射击.",
        type = "toggle",
        width = "full"
    } )
