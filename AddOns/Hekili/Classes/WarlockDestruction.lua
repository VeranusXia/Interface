...
if UnitClassBase( 'player' ) == 'WARLOCK' then
    ...
    spec:RegisterAbilities( {
        ...
        dark_pact = {
            ...
            usable = function () return health.pct > 20, "血量不足" end,
            handler = function ()
                applyBuff( "dark_pact" )
        ...
        havoc = {
            ...
            usable = function () return not pvptalent.bane_of_havoc.enabled and active_enemies > 1, "需要多个目标且没有bane_of_havoc" end,
            handler = function ()
        ...
        bane_of_havoc = {
            ...
            usable = function () return active_enemies > 1, "需要多个目标" end,
        ...
        health_funnel = {
            ...
            usable = function () return pet.active and pet.alive and pet.health_pct < 100, "需要宠物" end,
            start = function ()
        ...
        singe_magic = {
            ...
            usable = function ()
                return pet.imp.alive or buff.grimoire_of_sacrifice.up, "需要小恶魔或 grimoire_of_sacrifice"
            end,
            handler = function ()
        ...
        subjugate_demon = {
            ...
            usable = function () return target.is_demon and target.level < level + 2, "需要恶魔目标" end,
            handler = function ()
        ...
        summon_felhunter = {
            ...
            usable = function ()
                if pet.alive then return false, "宠物还活着"
        ...
        summon_imp = {
            ...
            usable = function ()
                if pet.alive then return false, "宠物还活着"
                elseif buff.grimoire_of_sacrifice.up then return false, "grimoire_of_sacrifice有了" end
                return true
            end,
            handler = function ()
                summonPet( "imp" )
        ...
        summon_voidwalker = {
            ...
            usable = function ()
                if pet.alive then return false, "宠物活着"
                elseif buff.grimoire_of_sacrifice.up then return false, "grimoire_of_sacrifice有了" end
                return true
            end,
            handler = function ()
    ...
    spec:RegisterSetting( "havoc_macro_text", nil, {
        name = "当|T460695:0|t浩劫显示在|TInterface\\Addons\\Hekili\\Textures\\Cycle:0|t指示器, 插件建议你对不同的目标施放浩劫(互不影响). 鼠标移动宏在这方面很有用, 下面是一个例子.",
        type = "description",
        width = "full",
        fontSize = "medium"
    } )
    ...
    spec:RegisterSetting( "immolate_macro_text", nil, {
        name = function () return "当|T" .. GetSpellTexture( 348 ) .. ":0|t献祭显示在|TInterface\\Addons\\Hekili\\Textures\\Cycle:0|t 指示器, 插件建议你对不同的目标施放献祭(互不影响). 鼠标移动宏在这方面很有用, 下面是一个例子." end,
        type = "description",
        width = "full",
        fontSize = "medium"
    } )
    ...
    spec:RegisterSetting( "immolate_macro", nil, {
        name = function () return "|T" .. GetSpellTexture( 348 ) .. ":0|t 献祭宏" end,
        type = "input",
        width = "full",
        multiline = 2,
