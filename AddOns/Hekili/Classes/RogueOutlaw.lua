...
if UnitClassBase( "player" ) == "ROGUE" then
    ...
    spec:RegisterAbilities( {
        ...
        cheap_shot = {
            ...
            usable = function ()
                if target.is_boss then return false, "假设在BOSS战中无法使用cheap_shot" end
        ...
        gouge = {
            ...
            usable = function () return talent.dirty_tricks.enabled and settings.dirty_gouge, "需要dirty_tricks和dirty_gouge确认" end,
        ...
        slice_and_dice = {
            ...
            usable = function()
                return combo_points.current > 0, "需要combo_points"
            end,
        ...
        stealth = {
            ...
            usable = function ()
                if time > 0 then return false, "战斗中不能隐身"
                elseif buff.stealth.up then return false, "隐身"
                elseif buff.vanish.up then return false, "消失" end
                return true
            end,
    ...
    spec:RegisterSetting( "mfd_points", 3, {
        ...
        desc = "只有当你拥有指定数量的连击点数或更少时插件才会推荐|T236364:0|t 死亡标记.",
        type = "range",
        min = 0,
        max = 5,
        step = 1,
    ...
    spec:RegisterSetting( "dirty_gouge", false, {
        name = "使用邪恶计谋下的|T132155:0|t 凿击",
        desc = "如果勾选, 当选择邪恶计谋天赋而你又没有足够的能量来进行影袭时 " ..
            "插件会推荐凿击.  |cFFFFD100这对于定位来说可能是个问题|r, 因为你需要在你的目标 " ..
            "面前.\n\n默认情况下此设置未被选中.",
        type = "toggle",
        width = "full",
    } )
