...
if UnitClassBase( "player" ) == "DRUID" then
    ...
    spec:RegisterAbilities( {
        ...
        maim = {
            ...
            usable = function () return combo_points.current > 0, "需要连击点" end,
            handler = function ()
    ...
    spec:RegisterSetting( "starlord_cancel", false, {
        name = "撤销|T462651:0|t星辰领主",
        desc = "如果勾选, 插件会建议取消星辰领主buff，然后再开始用星涌叠层.\n\n" ..
            "你可能会希望|cFFFFD100/cancelaura 星辰领主宏在战斗期间进行管理.",
        icon = 462651,
    ...
    spec:RegisterSetting( "solo_drift", false, {
        name = "在单目标中使用带有星辰漂流天赋的 |T236168:0|t 星辰坠落",
        desc = "如果勾选, 该插件将在单目标中加入对|T236168:0|t 星辰坠落的推荐.  这可以让你在星辰坠落过程中边移动边施放.\n\n" ..
            "这是一个DPS的损失但在大秘境可能会有用.",
        icon = 236168,
        iconCoords = { 0.1, 0.9, 0.1, 0.9 },
        type = "toggle",
        width = "full"        
    ...
    class.specs[0].abilities.cancel_buff.funcs.usable = setfenv( function ()
        if not settings.starlord_cancel and args.buff_name == "starlord" then return false, "星辰领主撤销选项被禁用" end
        return args.buff_name ~= nil, "没有检测到buff名称"
    end, state )
