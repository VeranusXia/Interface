...
if UnitClassBase( "player" ) == "PALADIN" then
    ...
    spec:RegisterAbilities( {
        ...
        cleanse_toxins = {
            ...
            usable = function ()
                return buff.dispellable_poison.up or buff.dispellable_disease.up, "需要毒药或疾病"
            end,
        ...
        hammer_of_wrath = {
            ...
            usable = function () return target.health_pct < 20 or ( level > 57 and buff.avenging_wrath.up ) or buff.hammer_of_wrath_hallow.up or buff.negative_energy_token_proc.up, "需要低血量, avenging_wrath, 或ashen_hallow" end,
            handler = function ()
                gain( buff.holy_avenger.up and 3 or 1, "holy_power" )
