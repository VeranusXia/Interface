...
if UnitClassBase( "player" ) == "HUNTER" then
    ...
    spec:RegisterAbilities( {
        ...
        harpoon = {
            ...
            usable = function () return settings.use_harpoon and target.distance > 8, "鱼叉失效或目标太近" end,
            handler = function ()
        ...
        intimidation = {
            ...
            usable = function () return pet.alive, "需要一个活着的宠物" end,
            handler = function ()
        ...
        kill_shot = {
            ...
            usable = function () return buff.flayers_mark.up or target.health_pct < 20, "要求目标血量低于20%" end,
            handler = function ()
        ...
        misdirection = {
            ...
            usable = function () return pet.alive or group, "需要一个活着的宠物或盟友" end,
            handler = function ()
        ...
        tranquilizing_shot = {
            ...
            usable = function () return buff.dispellable_enrage.up or buff.dispellable_magic.up, "需要dispellable_enrage或dispellable_magic" end,
            handler = function ()
    ...
    spec:RegisterSetting( "use_harpoon", true, {
        name = "|T1376040:0|t 使用鱼叉猛刺",
        desc = "如果勾选, 当你超出了射程并且有鱼叉猛刺的时候，插件会推荐使用|T1376040:0|t鱼叉猛刺.",
        type = "toggle",
        width = 1.49
    } )
    
    spec:RegisterSetting( "ca_vop_overlap", false, {
        name = "|T2065565:0|t协同进攻叠加(完美愿景)",
        desc = "如果勾选, 插件会推荐|T2065565:0|t协同进攻即使这个buff已经因为完美愿景而被应用了.\n" ..
            "当延迟协同进攻会使你在一场特定的战斗中损失一个或多个协同进攻时这可能是首选.",
        type = "toggle",
        width = "full"
    } )
