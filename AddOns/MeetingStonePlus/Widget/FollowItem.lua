...
local FollowIcons = {
    [FOLLOW_STATUS_UNKNOWN] = [[Interface\AddOns\MeetingStonePlus\Media\FollowStatus\Unknown]],
    [FOLLOW_STATUS_STARED]  = [[Interface\AddOns\MeetingStonePlus\Media\FollowStatus\Stared]],
    [FOLLOW_STATUS_FRIEND]  = [[Interface\AddOns\MeetingStonePlus\Media\FollowStatus\Friend]],
}
