...
function AppParent:OnEnable()
    local FollowButton = CreateFrame('Button', nil, UIParent) do
        FollowButton:SetNormalTexture([[Interface\AddOns\MeetingStonePlus\Media\ButtonUp]])
        FollowButton:SetPushedTexture([[Interface\AddOns\MeetingStonePlus\Media\ButtonDown]])
