...
local function CommonTooltip_OnEnter(self)
	...
	elseif self.currencyID then
		...
		if self.currencyID == 1889 then
			GameTooltip:AddLine("|n当前战役进度: " .. "|cffffffff" .. C_CurrencyInfo.GetCurrencyInfo(self.currencyID).quantity)
			GameTooltip:Show()
		end
...
local function DoomRun_OnEnter(self)
	...
	GameTooltip:AddLine(("失败以后每人获得 |cff00ff00%s XP|r 经验."):format(BreakUpLargeNumbers(xpR)), 1,1,1,1)
	GameTooltip:AddLine(" ")
