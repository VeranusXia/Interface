...
L["Zandalar"] = "赞达拉"
 ...
 L["Zuldazar"] = "祖达萨"
L["Argus"] = "阿古斯"
 L["Antorian Wastes"] = "安托兰废土"
 L["Krokuun"] = "克罗库恩"
 L["Mac'Aree"] = "玛凯雷"

--4.9.9 OptionList.lua
L["Show Import Button"] = "显示导入按钮"
L["Add a button to the toolar to import a single team or many teams exported from Rematch."] = "导入来自Rematch的单个或多个队伍。"
L["Use Random If Queue Empty"] = "升级槽随机"
L["When the queue is empty, use a random high level pet instead of ignoring the slot when a team loads."] = "当没有升级小宠时,该小宠升级槽将随机加载高级宠物，而不是忽略。"
L["But Not After PVP Battle"] = "PVP战斗结束后不显示"
L["Since pets don't remain injured in PVP battles, don't show the window when leaving a PVP battle."] = "因为宠物不会在PVP战斗中受伤，所以在离开PVP战斗时不要显示窗口。"

--4.9.8 OptionList.lua
L["After Pet Battles Too"] = "对战结束以后"
L["Also load healthiest pets after leaving a pet battle or using a Revive or Bandage within Rematch.\n\n\124cffffffffNote:\124r Use of Revive or Bandages outside Rematch will not be noticed.\n\nThis is an experimental option. If you experience problems and want to report them, \124cffffffffPLEASE\124cffffffff mention that this option is enabled!\124r"] = "在对战之后或者在复赛后使用复活或绷带，也可以加载最健康的宠物。\n\n\124cffffffffNote:\124r 在复赛外使用复活或绷带不会生效。\n\n这是一个实验选项，如果你遇到问题并想报告它们，请先查看\124cffffffff此选项是否勾选！\124r"
L["Show Icon For Pets In Teams"] = "宠物有队伍提示"
L["When a pet belongs to a team, show an icon beside their name in the pet list and queue."] = "当一只小宠物有队伍时，会在列表中显一个小爪子，用以提示。"
L["Team Win Record Options"] = "胜负记录"

--4.9.0其他添加
L["Rematch"] = "宠物组合"
--Cards\PetCard.lua
L["Revoked"] = "无法使用"
L["\124cffff0000Revoked"] = "\124cffff0000无法使用"
L["This pet has been revoked, which means Blizzard withdrew your ability to use this pet.\n\nThis commonly happens when a pets no longer meet a condition for ownership, such as the Core Hound Pup requiring an authenticator attached to the account."] = "该宠物虽然已学习，但暴雪检测到你该战网没有购买解锁，所以宠物无法使用（可能你是通过角色转移获得的，但必须购买才能解锁）"
L["Can't Summon"] = "无法召唤"
L["This pet can't be summoned.\n\nA common reason is a faction restriction, such as the opposing faction's version of the Moonkin Hatchling."] = "该宠物无法被召唤，可能已死亡，或者是对立阵营宠物。"

--4.9.0
--Panels\OptionList.lua
L["Slow Mousewheel Scroll"] = "慢速滚动"
L["In the Pets, Teams, Queue and Options lists, mousewheel over the list will scroll one line at a time instead of a whole page at a time.\n\nYou can still scroll by pages by clicking above or below the scroll thumb."] = "慢速滚动鼠标，现在鼠标以每一行慢速滚动，关闭原来每一页的快速滚动。"
L["In the Teams and Pets tabs (soon for Queue and Options), mousewheel over the list will scroll one line at a time instead of a whole page at a time.\n\nYou can still scroll by pages by clicking above or below the scroll thumb."] = "慢速滚动鼠标，现在鼠标以每一行慢速滚动，关闭原来每一页的快速滚动。"
-- New strings in 4.8.10
-- Panels\OptionPanel.lua
L["Allow Any Version"] = "允许任何属性"
L["Show Species ID & Ability ID"] = "显示成长ID和技能ID"
L["Display the numerical species ID of a pet as a stat on their pet card and the numerical ability ID on ability tooltips."] = "在宠物面板上显示成长ID，在鼠标提示里添加技能ID"
L["Load Healthiest Pets"] = "加载最健康的宠物"
L["Instead of choosing only the healthiest pet with identical stats, choose the healthiest version of the pet regardless of stats."] = "不要只选择具有相同属性的最健康的宠物，而是选择最健康的，不用管属性如何"
L["Allow Random Pets From Teams"] = "允许来自团队的随机宠物" 
L["The default behavior for a random pet slot is to not choose a random pet saved in another team, unless all three pet slots are random.\n\nEnable this option to always allow pets from other teams to be included in the random pool."] = "随机宠物插槽的默认行为是不选择保存在另一个团队中的随机宠物，除非所有三个宠物插槽都是随机的。\n\n 启用此选项始终允许来自其他团队的宠物被包括在随机池中。"
L["Use Level In Strong Vs Filter"] = "技能使用等级"
L["When doing a Strong Vs filter, take the level of the pet into account. If a pet is not high enough level to use a Strong Vs ability, do not list the pet.\n\n\124cffffffffNote:\124r A Strong Vs filter is sometimes useful for identifying pets you want to level or capture. This option will hide those pets while the Strong Vs filter is active."] = "当启用此过滤时，搜索技能只会显示等级够点亮此技能的宠物。如果因等级不够，无法使用该技能时，该宠物不会列出。"
L["Allow Hidden Pets"] = "允许隐藏宠物"
L["Allow the ability to hide specific pet species in the pet list with a 'Hide Pet' in the list's right-click menu.\n\nYou can view pets you've hidden from the Other -> Hidden Pets filter."] = "允许在宠物列表中隐藏特定的宠物种类，并在列表中的右键单击菜单中显示“隐藏宠物”"
L["Debugging Options"] = "调试选项"
--L["Debug: Journal FrameLevel"] = "" 
--L["Check this to less aggressively try to take over the default pet journal. Specifically, it will give up sooner if it can't raise frame level above all other addons' frames in the journal."] = ""
--L["Debug: No Cache"] = ""
...
--L["Debug: Delay Journal"] = ""
--L["Delay Rematch taking over the journal on the first launch by a full second."] = ""
--L["Delay Just One Frame"] = ""
--L["Change the delay from half a second to one frame, or nearly instant."] = ""
--L["Debug: No Models"] = ""
--L["Prevent the creation or rendering of any models within Rematch. This includes the target panel, loadout slots and pet card.\n\n\124cffff4040This option requires a Reload."] = ""
...
-- New strings in 4.6.8
	...
	L["Broken Isle"] = "破碎海滩"
	L["Import a single team or many teams that were exported from Rematch."] = "导入来自Rematch的单个或多个队伍。"
...
-- Menus\TeamMenus.lua
	...
	L["Import Team"] = "导入队伍"
	L["Import a single team or many teams that was exported from Rematch."] = "导入来自Rematch的一个或多个队伍"
	L["Send Team"] = "发送队伍"
...
-- Panels\QueuePanel.lua
	...
	L["Type"] = "宠物类型"
	L["Queue"] = "升级" --下方四个选项卡， 不要[升级队列]四个字，只要升级二个字。
	L["Sort by:"] = "排序方式:"
	...
	L["Pause Preferences"] = "暂停队伍升级设定"
	L["Suspend all preferred loading of pets from the queue, except for pets that can't load."] = "暂停队伍的升级设定，小宠将按照先后顺序，依次加载入升级槽。"
	L["Fill Queue"] = "加入升级队列"
...
-- Panels\OptionPanel.lua
    ...
    L["Change the relative size of the standalone window to anywhere between 50% and 200% of its standard size.\n\n\124cffffffffNote:\124r This setting (like the other Standalone Window Options) \124cffffffffdoes not\124r affect the pet journal window."] = "更改独立窗口的相对大小，介于标准大小的50%与200%之间"
...
-- Dialogs\Preferences.lua
	...
	L["Expected Damage Taken"] = "预期受到对方伤害的技能类型："
	L["Tab"] = "标签页"
	L["Leveling Preferences"] = "队伍升级设定"
	L["Team Preferences"] = "队伍升级设定"
	L["Tab Preferences"] = "标签页设定"
	--L["  For %s pets: %s%d%s"] = "当为%s宠时,考虑爆击1.50后的最低血量: %s%d%s"
	L["  For %s pets1: %s%d%s"] = "当为%s宠时,考虑重击1.50后的最低血量: %s%d%s"
	L["  For %s pets2: %s%d%s"] = "当为%s宠时,考虑轻击0.66后的最低血量: %s%d%s"
	...
	L["Leveling Preferences For %s:"] = "%s的升级设定:"
	L["Expected damage taken"] = "预期受到对方伤害的技能类型"
	L["The minimum health of pets can be adjusted by the type of damage they are expected to receive."] = "宠物的最低血量会根据预期受到的伤害类型调整"
	L["Damage expected"] = "预期受到对方伤害的技能类型"
	--L["  For %s pets: \124cffffd200%d"] = "当为%s宠时,考虑轻击0.66后的最低血量: \124cffffd200%d"
	L["  For %s pets1: \124cffffd200%d"] = "当为%s宠时,考虑重击1.50后的最低血量: \124cffffd200%d"
	L["  For %s pets2: \124cffffd200%d"] = "当为%s宠时,考虑轻击0.66后的最低血量: \124cffffd200%d"
...
-- Dialogs\Collection.lua
	...
	L["Unique Pets In the Journal"] = "游戏中的独特宠物"
	L["Collection Statistics"] = "收藏统计"
	L["There are %s%d\124r unique pets in the journal"] = "当前游戏版本共有独特宠物%s%d\124r只"
	...
	L["You have %s%.1f%%\124r of those unique pets"] = "你已收集%s%.1f%%\124r的独特宠物"
